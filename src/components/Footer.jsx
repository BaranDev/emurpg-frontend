    ...
    <footer className="bg-gray-800 border-t-2 border-yellow-600 py-2 mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center space-y-2">
          <p className="text-lg text-yellow-500 font-medieval text-center">Join Our Community</p>
          ...
          <p className="text-xs text-gray-400 mt-4 text-center px-4">{config.FOOTER_TEXT}</p>
        </div>
      </div>
    </footer>
  );
