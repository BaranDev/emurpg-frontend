...
import { FaPlay, FaPause, FaVolumeUp, FaVolumeMute, FaMusic, FaChevronLeft, FaChevronRight } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          background: isMuted ? "rgba(239, 68, 68, 0.2)" : currentTheme.accentLight,
