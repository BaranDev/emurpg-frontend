...
const CharrollerLandingPage = ({ onLanguageSwitch }) => {
  ...
  return (
    <>
      ...
      <CharrollerNavbar theme="arcane" onLanguageSwitch={onLanguageSwitch} />
          ...
          <section className="relative h-screen flex items-center justify-center">
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <div className="flex items-center justify-center gap-3 mb-4 animate-slideDown">
                <h1 className="font-cinzel text-5xl md:text-7xl font-bold text-white drop-shadow-[0_0_20px_rgba(74,158,255,0.5)]">
                  {t("charroller.hero_title")}
                </h1>
              </div>

              {/* Subtitle */}
              <p className="text-xl md:text-2xl mb-4 text-blue-200 drop-shadow-[0_0_10px_rgba(74,158,255,0.3)] animate-fadeIn">
                {t("charroller.hero_subtitle")}
              </p>

              {/* Description */}
              <p className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto animate-fadeIn">
